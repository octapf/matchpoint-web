...
export function SiteHeader(props: SiteHeaderProps) {
  ...
  if (props.variant === "list") {
    return (
      <header
        className="sticky top-0 z-20 shrink-0 border-b border-mp-surface-light bg-mp-bg/95 backdrop-blur-sm"
        role="banner"
      >
        <div className="mx-auto flex w-full max-w-6xl items-center justify-between gap-3 px-4 py-3 sm:px-6 lg:max-w-[100rem] lg:px-8 lg:py-3">
          <Link
            href="/"
            className="flex min-w-0 items-center gap-3 rounded-md outline-none ring-mp-yellow focus-visible:ring-2"
          >
            <Image
  ...
  return (
    <header
      ...
      role="banner"
    >
      <div className="mx-auto flex w-full max-w-6xl items-start gap-3 px-4 py-4 sm:items-center sm:gap-4 sm:px-6 lg:max-w-[100rem] lg:px-8">
        <Link
          href="/"
